...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_1.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_2.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_3.png}
	\caption{Disequilibrium model output results for the degree of melting, residual melt porosity, and activity ratios ($^{230}$Th/$^{238}$U), ($^{226}$Ra/$^{230}$Th), and ($^{231}$Pa/$^{235}$U) as a function of pressure, for the Damk\"{o}hler number shown ($Da = 0$). For comparison, the dashed gray curves show solutions for the equilibrium transport model.}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_4.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_6.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_8.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_9.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_10.png}
...
\begin{figure}[H]
	\noindent\includegraphics[width=\textwidth]{Figure_11.png}
